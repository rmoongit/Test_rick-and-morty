<template>
  <div class="icon">
    ...
    >
      ...
      <polygon
        fill="url(#XsTRcLoXx-vG_AiVGAoRha)"
        points="39.004,10.06 32,22.06 24.996,10.06 14.879,10.06 32,39.393 49.121,10.06"
      />
      <linearGradient
        id="XsTRcLoXx-vG_AiVGAoRhb"
        x1="32"
        x2="32"
        y1="59.06"
        y2="9.06"
